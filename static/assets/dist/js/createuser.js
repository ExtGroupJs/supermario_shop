...
$(function () {
  ...
  $(".select2").select2({
    dropdownParent: $("#modal-crear-usuario"),
    theme: "bootstrap4",
  });
});
...
function mostrarUserConfig(id) {
  ...
  axios
      ...
      if (result.isConfirmed) {
        ...
        axios
          ...
          .then(() => {
            Swal.fire(
              "Éxito",
              "Roles y tienda guardados correctamente",
              "success"
            );
            table.ajax.reload();
          })
          .catch(() => {
            Swal.fire(
              "Error",
              "No se pudieron guardar los roles o la tienda",
              "error"
            );
          });
      }
    ...
    .catch(() => {
      Swal.fire(
        "Error",
        "No se pudieron obtener los datos del usuario, roles o tiendas",
        "error"
      );
    });
}
