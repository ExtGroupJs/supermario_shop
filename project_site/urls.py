...
urlpatterns = [
    ...
    path("client-gestion/", include("apps.clients_app.urls")),
    ...
    path("index/", login_required(pages.user_redirect), name="index"),
        path("", pages.wholesale_catalog, name="catalog"),
    ...
    path("wholesale_catalog/", pages.wholesale_catalog, name="wholesale_catalog"),
    path(
    ...
    path(
        "shop_products_auto_movil/",
        login_required(pages.shop_products_auto_movil),
        name="shop_products_auto_movil",
    ),
    path(
        "create_sales_auto_movil/",
        login_required(pages.create_sales_auto_movil),
        name="create_sales_auto_movil",
    ),
    path(
        "edit_product_image_movil/",
        login_required(pages.edit_product_image_movil),
        name="edit_product_image_movil",
    ),
